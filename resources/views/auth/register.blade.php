...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header Auth"><strong>{{ __(' You Can REGISTER Here') }}</strong></div>
                <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="gender" id="gender" class="form-control">
                                    <option value="male" class="form-check-input{{ $errors->has('male') ? ' is-invalid' : '' }}">Male</option>
                                    <option value="female" class="{{ $errors->has('female') ? ' is-invalid' : '' }}">Female</option>
                                    <option value="other" class="{{ $errors->has('other') ? ' is-invalid' : '' }}">Other</option>
